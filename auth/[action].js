...
// Versi: 2.2.0 — token tidak lagi kadaluarsa (sesi permanen, hilang hanya jika localStorage dihapus)
...
async function verifyToken(token) {
  try {
    ...
    // Token tidak lagi dicek kadaluarsa — sesi berlaku selamanya
    // sampai user menghapus localStorage / cache browser
